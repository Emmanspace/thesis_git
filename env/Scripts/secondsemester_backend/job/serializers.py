...
from .models import User, History, Category, Notification, Departments, totalSlots, availableSlots, parkingSlots, real_time, historytab#,  UserProfile#, userEdit, User
...
#     class Meta:
#         model = User
#         fields = ('email', 'password', 'first_name', 'last_name', 'plate')  # Adjust fields as needed
#         extra_kwargs = {'password': {'write_only': True}}  # Handle password separately
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('email', 'password', 'first_name', 'last_name', 'plate')
        extra_kwargs = {'password': {'write_only': True}}
